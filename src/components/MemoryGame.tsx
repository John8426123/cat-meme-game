...
// 動態載入素材
const ASSETS = [
    { id: "1", image: `${BASE}assets/images/希特勒貓.gif`, sound: `${BASE}assets/sounds/希特勒貓.mp3` },
    { id: "2", image: `${BASE}assets/images/抱頭貓.gif`, sound: `${BASE}assets/sounds/抱頭貓.mp3` },
    { id: "3", image: `${BASE}assets/images/香蕉貓哭.gif`, sound: `${BASE}assets/sounds/香蕉貓哭.mp3` },
    { id: "4", image: `${BASE}assets/images/pop貓.gif`, sound: `${BASE}assets/sounds/pop貓.mp3` },
    { id: "5", image: `${BASE}assets/images/huh貓.gif`, sound: `${BASE}assets/sounds/huh貓.mp3` },
    { id: "6", image: `${BASE}assets/images/happy貓.gif`, sound: `${BASE}assets/sounds/happy貓.mp3` },
];
...
// 失敗時隨機播放的影片
const FAIL_VIDEOS = [`${BASE}嘲笑貓.mp4`, `${BASE}huh貓.mp4`];

export function MemoryGame({ onComplete, onFail, maxFails = 6 }: MemoryGameProps) {
